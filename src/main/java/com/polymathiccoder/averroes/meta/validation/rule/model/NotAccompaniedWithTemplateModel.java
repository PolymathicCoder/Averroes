...
@AutoProperty
public class NotAccompaniedWithTemplateModel {
	private final String annotationTypeSimpleName;
	private final List<String> otherAnnotationTypesSimpleNameList;
	
	public NotAccompaniedWithTemplateModel(String annotationTypeSimpleName, List<String> otherAnnotationTypesSimpleNameList) {
	...
	public String getOtherAnnotationTypesExpression () {
		return DroolsSyntaxHelper.buildExpression(otherAnnotationTypesSimpleNameList, "contains", "||");
	}
