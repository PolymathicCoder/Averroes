...
@AutoProperty
public class AccompaniedWithTemplateModel {
	private final String annotationTypeSimpleName;
	private final List<String> otherAnnotationTypesSimpleNameList;
	
	public AccompaniedWithTemplateModel(String annotationTypeSimpleName, List<String> otherAnnotationTypesSimpleNameList) {
